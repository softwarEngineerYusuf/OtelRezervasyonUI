...
function Çanakkale() {
  const [çanakkaleHotels, setÇanakkaleHotels] = useState([]);
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        const çanakkaleOtelListesi = response.data.$values.filter(
          (otel) => otel.sehirİsim === "Çanakkale"
        );
        setÇanakkaleHotels(çanakkaleOtelListesi);
      })
  ...
  return (
    <section className="main container section">
      ...
      <div className="container">
        <div className="row">
          {çanakkaleHotels.map((hotel, index) => (
