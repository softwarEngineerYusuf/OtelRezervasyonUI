...
function İstanbul() {
  const [istanbulHotels, setIstanbulHotels] = useState([]);
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        const istanbulOtelListesi = response.data.$values.filter(
          (otel) => otel.sehirİsim === "İstanbul"
        );
        setIstanbulHotels(istanbulOtelListesi);
      })
  ...
  return (
    <section className="main container section">
      ...
      <div className="container">
        <div className="row">
          {istanbulHotels.map((hotel, index) => (
                ...
                >
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <img
                        src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/122679728.jpg?k=64298b3f2d767f198d982b2fc2aa893d5f0cdc31703161b9be9d5aafe9103983&o=&hp=1"
                    ...
                    <div className="carousel-item">
                      <img
                        src="https://images.trvl-media.com/lodging/8000000/7870000/7862700/7862678/36e93b07.jpg?impolicy=resizecrop&rw=500&ra=fit"
                        className="d-block w-100 "
                        alt="Resim 2"
                        width="300"
                        height="300"
                    ...
                    <div className="carousel-item">
                      <img
                        src="https://cdn.kiwicollection.com/media/property/PR005538/xl/005538-12-Bosphorus%20Suite%20with%20Balcony.jpg?cb=1469563178"
                        className="d-block w-100 "
                        alt="Resim 2"
                        width="300"
                        height="300"
                    ...
                    <div className="carousel-item">
                      <img
                        src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0c/7f/2e/1e/pool.jpg?w=700&h=-1&s=1"
                        className="d-block w-100 "
                        alt="Resim 2"
                        width="300"
                        height="300"
