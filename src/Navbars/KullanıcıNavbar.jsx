...
function KullanıcıNavbar({ users }) {
        ...
        <div className={active}>
          <ul className="navLists flex">
            <li className="navItem">
              <Link to="/Kullanıcı" className="navLink">
                Anasayfa
              </Link>
            </li>
            ...
            <li className="navItem">
              <Link to="/">
                <button className="btn-çıkış" onClick={handleLogout}>
...
export default KullanıcıNavbar;
