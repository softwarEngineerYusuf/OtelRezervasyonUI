import "./kayıtKullanıcıNavbar.css";
...
function KayıtKullanıcıNavbar() {
  const { userSecondData } = useUserContext();
        ...
        <div className={active}>
          <ul className="navLists flex">
            <li className="navItem">
              <Link to="/KayıtKullanıcıNavbar" className="navLink">
                Anasayfa
              </Link>
            </li>
            ...
            <li className="navItem">
              <a href="#" className="navLink">
                <FontAwesomeIcon
                  ...
                  style={{ color: "var(--PrimaryColor)" }}
                />
                <span className="kişi-isim">{userSecondData.name}</span>
              </a>
            </li>
...
export default KayıtKullanıcıNavbar;
